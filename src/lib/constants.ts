export const STATUS_COLORS = {
  ...
  pending_supervisor_review: 'bg-rose-100 text-rose-700 dark:bg-rose-500/10 dark:text-rose-400',
...
export const STATUS_LABELS = {
  ...
  pending_respective_supervisor_confirmation: 'Pending Respective Supervisor Confirmation',
  respective_supervisor_confirmed: 'Confirmed by Respective Supervisor',
