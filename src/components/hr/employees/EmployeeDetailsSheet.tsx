  ...
  return (
    <Sheet open={open} onOpenChange={onOpenChange}>
      <SheetContent className="overflow-y-auto sm:max-w-3xl">
        ...
        <div className="py-4">
          {/* Employee ID + Name header (always visible) */}
          <div className="grid grid-cols-2 gap-4 mb-4">
            ...
            <div className="grid gap-2">
              ...
              {isEditing ? (
                ...
                <div className="text-sm font-semibold bg-muted/50 p-2 rounded">{employee.full_name}</div>
              )}
            </div>
          </div>
          ...
          <Tabs defaultValue="personal" className="w-full">
            ...
            <TabsContent value="payroll" className="mt-4">
              ...
              <div className="mt-6">
                <h4 className="text-sm font-semibold mb-1">Contribution Rate Overrides</h4>
