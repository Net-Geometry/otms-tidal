                  ...
                  <div key={session.id} className="flex items-center justify-between p-3 bg-muted/30 rounded-lg">
                    ...
                    >
                      <StatusWithMetadata 
                        ...
                        rejectionStage={session.request.rejection_stage}
                        tooltip={getStatusTooltip(session.request as any)}
                        metadata={getOTApproverMetadata(session.request)}
                      />
                    </button>
                  </div>
                ))}
              ...
              <div className="grid grid-cols-3 gap-4 items-start">
                ...
                <div className="text-right">
                  ...
                  <div className="flex justify-end">
                    <StatusWithMetadata 
                      status={grouped.statuses[0]} 
                      rejectionStage={grouped.sessions[0]?.request?.rejection_stage}
                      tooltip={grouped.sessions[0]?.request ? getStatusTooltip(grouped.sessions[0].request as any) : null}
                      metadata={getOTApproverMetadata(grouped.sessions[0]?.request)}
                    />
                  </div>
                </div>
              </div>
