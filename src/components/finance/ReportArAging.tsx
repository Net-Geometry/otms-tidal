...
import { useArAging } from '@/hooks/finance/useFinanceReports';
import { generateArAgingPdf } from '@/lib/financeReportPdfGenerator';
...
export function ReportArAging() {
  ...
  return (
    <Card>
      <CardHeader>
        <CardTitle className="text-base">AR Aging Report</CardTitle>
      </CardHeader>
      <CardContent className="space-y-4">
        ...
        {report.isLoading ? (
          ...
          <div className="py-10 text-center text-sm text-muted-foreground">No outstanding AR invoices found.</div>
        ) : (
